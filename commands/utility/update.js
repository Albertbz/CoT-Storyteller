const { SlashCommandBuilder, InteractionContextType, MessageFlags, time, TimestampStyles, strikethrough, hyperlink, bold, italic, inlineCode, userMention } = require("discord.js");
...
module.exports = {
  ...
  async execute(interaction) {
    if (interaction.options.getSubcommand() === 'recruitment') {
      ...
      const houseInfoChannel = await interaction.guild.channels.fetch(channels.housesInfo);
      ...
      if (recruitmentPostExists) {
        ...
        recruitmentPostMessage.edit(fullMessage);
      }
      else {
