...
module.exports = (sequelize, DataTypes) => {
  return sequelize.define('regions', {
    ...
    formattedInfoNoSteelbearers: {
      ...
      set(value) {
        throw new Error('Do not try to set the `formattedInfoNoSteelbearers` value!');
      }
    },
    formattedInfo: {
      type: DataTypes.VIRTUAL,
      async get() {
        ...
        const steelbearerInfo = steelbearerInfoList.length > 0 ? '- ' + steelbearerInfoList.join('\n- ') : 'None';
