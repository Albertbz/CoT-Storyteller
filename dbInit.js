...
sequelize.sync({ force }).then(async () => {
  await Worlds.create({ name: 'Elstrand', currentYear: 18 });

  await Affiliations.create({ roleId: roles.riverhelm, name: 'Dayne', emojiName: 'dayne', isRuling: true, state: 'Almost Full', role1: 'Builders', role2: 'Miners', role3: 'Clockmakers' });
  await Affiliations.create({ roleId: roles.eshaeryn, name: 'Du Vēzos', emojiName: 'duvezos', isRuling: true, state: 'Urgent', role1: 'Hunters', role2: 'Farmers', role3: 'Cooks' });
  ...
  await Affiliations.create({ roleId: roles.theHeartlands, name: 'Merrick', emojiName: 'merrick', isRuling: true, state: 'Open', role1: 'Lumberjacks', role2: 'Builders', role3: 'Soldiers' });
  await Affiliations.create({ roleId: roles.theBarrowlands, name: 'Nightlocke', emojiName: 'nightlocke', isRuling: true, state: 'Almost Full', role1: 'Builders', role2: 'Lumberjacks', role3: 'Farmers' });
  await Affiliations.create({ roleId: roles.vernados, name: 'Stout', emojiName: 'stout', isRuling: true, state: 'Open', role1: 'Cooks', role2: 'Farmers', role3: 'Soldiers' });
  await Affiliations.create({ roleId: roles.velkharaan, name: 'Wildhart', emojiName: 'wildhart', isRuling: true, state: 'Open', role1: 'Builders', role2: 'Miners', role3: 'Farmers' });
