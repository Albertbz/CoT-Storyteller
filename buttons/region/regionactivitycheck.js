...
module.exports = {
    ...
    async execute(interaction) {
        ...
        const container = new ContainerBuilder()
            .addTextDisplayComponents((textDisplay) =>
                textDisplay.setContent(
                    ...
                    `- An **Ingame Activity Check** will allow you to conduct a more detailed activity check using in-game mechanics such as books by adding a keyword that citizens can input on discord to note ingame completion.\n`
                )
            )
        ...
        const simpleActivityButton = new ButtonBuilder()
            .setCustomId('simple-activity-button')
            .setLabel('Simple Activity Check')
            .setEmoji('💬')
            .setStyle(ButtonStyle.Secondary);

        const detailedActivityButton = new ButtonBuilder()
            .setCustomId('detailed-activity-button')
            .setLabel('Detailed Activity Check')
            .setEmoji('✉️')
            .setStyle(ButtonStyle.Secondary);

        const ingameActivityButton = new ButtonBuilder()
            .setCustomId('ingame-activity-button')
            .setLabel('Ingame Activity Check')
            .setEmoji('🌲')
            .setStyle(ButtonStyle.Secondary);
